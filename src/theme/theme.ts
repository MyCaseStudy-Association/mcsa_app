...
export const lightColors = {
  ...
  loader: '#0F766E',
  loaderSurface: '#FFFFFF',
  loaderOnPrimary: '#FFFFFF',
  walletGradientStart: '#FFFFFF',
  walletGradientEnd: '#EAF8F5',
  accentTeal: '#2DD4BF',
...
export const darkColors: AppPalette = {
  ...
  buttonPrimaryText: '#ffffff',
  loader: '#14B8A6',
  loaderSurface: '#14211F',
  loaderOnPrimary: '#FFFFFF',
  walletGradientStart: '#14211F',
  walletGradientEnd: '#10312B',
  accentTeal: '#5EEAD4',
  ...
  sheetSurface: '#16241F',
  modalSurface: '#1A2D29',
  modalBorder: 'rgba(94, 234, 212, 0.28)',
  fieldSurface: '#152420',
